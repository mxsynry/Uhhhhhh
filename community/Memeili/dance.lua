...
table.insert(modules, function()
    ...
    m.Assets = {"MissMeFix.anim@MARKET/Memeili/MissMeFix.anim", "TungBung.mp3@MARKET/Memeili/TungBung.mp3"}
...
table.insert(modules, function()
    ...
    m.Assets = {"KwikFlip.anim@MARKET/Memeili/KwikFlip.anim", "Kwik Flip.mp3@MARKET/Memeili/Kwik%20Flip.mp3"}
    m.Config = function(parent)
        Util_CreateText(parent, "No settings.", 14, Enum.TextXAlignment.Center)
    end
    m.SaveConfig = function() return {} end
